        ...
        <tbody class="text-gray-700">
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    ...
                    <form action="{{ route('CResource.destroy', $resource->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <form method="POST" action="{{ route('CResource.store') }}">
                            @csrf
                            <div class="mb-4">
...
<script>
    ...
    function openEditResourceModal(element) {
        ...
        document.getElementById('editResourceForm').action = `/CResource/${resourceId}`;
